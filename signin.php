						...
						<form name="sign_in" method="POST" action="" >
							...
							<div class="row">
								...
								<div class="col-sm-4 text-right">
									...
									<button name="signin" type="submit" class="btn btn-primary btn-block btn-lg visible-xs mt-lg">Sign In</button>
								</div>
							</div>
...
<?php
			...
			$qz = "SELECT id FROM users where name='$username' and password='$userpassword'" ;
